...
export const getPresentDayAnalysis = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const getBacktestAnalysis = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const runFullAnalysis = async (req: any, res: any, next: NextFunction) => {
    try {
        ...
        const data = await ensurePresentDayAnalysis(totalCapital, riskPercentage);
        res.json(data);
    } catch (error: any) {
...
export const rerollSignal = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const refreshHorizon = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const getTacticalAnalysis = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const analyzeChart = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const postChatMessage = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const getSupervisorDirective = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const getRobustnessAudit = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const getMarketPrices = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const getVereditoExport = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const getMemeCoinAnalysis = async (req: any, res: any, next: NextFunction) => {
    try {
...
export const getSentimentAnalysis = async (req: any, res: any, next: NextFunction) => {
    try {
